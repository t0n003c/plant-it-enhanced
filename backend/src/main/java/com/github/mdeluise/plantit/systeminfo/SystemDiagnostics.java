...
public record SystemDiagnostics(String version, String revision, Instant checkedAt,
                                ComponentStatus database, ComponentStatus cache,
                                Map<String, ProviderDiagnostic> providers, String publicOutboundIp) {
